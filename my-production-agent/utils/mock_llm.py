"""Mock LLM — không cần API key thật. Trả lời giả lập."""
import random
import time
...
MOCK_RESPONSES = {
    "default": [
        ...
        "Trong production, đây sẽ là response từ OpenAI/Anthropic.",
    ...
    "deploy": [
        "Deployment là quá trình đưa code từ máy bạn "
        "lên server để người khác dùng được."
    ],
